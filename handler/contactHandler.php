...
if(strlen($_POST['LastName']) === 0){
    ...
    $FetchID = "SELECT max(ID) AS ID FROM dbj0u53roqb5xx.warren_junk_removal";        
    ...
    $InsertMessage = "INSERT INTO dbj0u53roqb5xx.warren_junk_removal (ID, name, email, phone_number, message, current_page, timestamp) VALUES ('$ID', '$Name', '$Email', '$PhoneNumber', '$Message', '$CurrentPage', '$Timestamp');";  
    ...
    $Subject = "New Lead From: Warren Junk Removal " . date("F j, Y, g:i a");
    ...
    // 'Reply-To: mooreoctavius94@gmail.com' . "\r\n";
    $UserMessage = "Hello, " . ucwords(strtolower($Name)) . " thank you for reaching out and submitting your request for an junk removal estimate. \n";
    ...
    // $Headers = "From: mooreoctavius94@gmail.com" . "\r\n";
    $Subject = "New Lead for Warren Junk Removal " . date("F j, Y, g:i a");
    // 'Reply-To: mooreoctavius94@gmail.com' . "\r\n";
    mail($ClientEmail, $Subject, $SendMessage);
